...
class UpdateEnseignantRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'statut.in' => 'Le statut doit être Permanent ou Vacataire.',
            'taux_horaire_perso.numeric' => 'Le taux horaire personnel doit être un nombre.',
            'taux_horaire_perso.min' => 'Le taux horaire personnel doit être positif.',
