...
Sauvegarde et restauration des données du système, avec sauvegardes automatiques paramétrables.

#### 3.9.2 Indicateurs

- **Dernière sauvegarde** : date de la dernière sauvegarde effectuée
- **Taille des données** : volume total des sauvegardes
- **Fréquence** : Automatique (lors de la connexion admin)

#### 3.9.3 Configuration des sauvegardes automatiques

Le système effectue automatiquement des sauvegardes lors de la connexion des administrateurs. Les paramètres sont configurables :

**Paramètres disponibles :**

- **Délai entre sauvegardes** (1-168 heures) : temps minimum avant de créer une nouvelle sauvegarde automatique lors d'une connexion admin
- **Rotation des sauvegardes** (1-30 sauvegardes) : nombre de sauvegardes automatiques à conserver (les plus anciennes sont automatiquement supprimées)

**Pour modifier la configuration :**

1. Dans la section "Configuration des sauvegardes automatiques", modifiez les champs souhaités
2. Cliquez sur **"Enregistrer la configuration"**

**Valeurs par défaut :**

- Délai : 24 heures
- Rotation : 7 sauvegardes

#### 3.9.4 Lancer une sauvegarde manuelle

1. Cliquez sur **"Lancer une sauvegarde"**.
2. Le système crée une archive des données.

**Note :** Les sauvegardes manuelles ne sont pas soumises à la rotation automatique et sont conservées indéfiniment jusqu'à suppression manuelle.

#### 3.9.5 Gestion des sauvegardes

Tableau listant toutes les sauvegardes avec :

- **Fichier** : nom du fichier de sauvegarde
- **Date** : date et heure de création
- **Taille** : volume du fichier
...
- **VHT** (Volume Horaire Total) calculé
- **Date** de réalisation
...
| Terme                         | Définition                                                                                                  |
| ----------------------------- | ----------------------------------------------------------------------------------------------------------- |
| **VHT**                       | Volume Horaire Total : nombre d'heures calculé selon le coefficient de complexité et le nombre de séquences |
