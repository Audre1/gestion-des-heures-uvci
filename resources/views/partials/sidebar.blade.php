<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('journaux.index') }}" class="nav-link {{ request()->routeIs('journaux.*') ? 'active' : '' }}">
            <i class="fa-solid fa-clipboard-list"></i> Journaux d'activités
        </a>
        <a href="{{ route('sauvegardes.index') }}" class="nav-link {{ request()->routeIs('sauvegardes.*') ? 'active' : '' }}">
            <i class="fa-solid fa-database"></i> Sauvegardes
        </a>

        {{-- Gestion pédagogique --}}
        <div class="nav-section-title">Gestion pédagogique</div>
        <a href="{{ route('enseignants.index') }}" class="nav-link {{ request()->routeIs('enseignants.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('affectations.index') }}" class="nav-link {{ request()->routeIs('affectations.*') ? 'active' : '' }}">
            <i class="fa-solid fa-link"></i> Affectations
        </a>
        <a href="{{ route('sequences.index') }}" class="nav-link {{ request()->routeIs('sequences.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('activites.index') }}" class="nav-link {{ request()->routeIs('activites.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('complementaires.index') }}" class="nav-link {{ request()->routeIs('complementaires.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('espace.activites') }}" class="nav-link {{ request()->routeIs('espace.activites') ? 'active' : '' }}">
            <i class="fa-solid fa-folder-open"></i> Mes activités
        </a>
        <a href="{{ route('espace.volume') }}" class="nav-link {{ request()->routeIs('espace.volume') ? 'active' : '' }}">
            <i class="fa-solid fa-stopwatch"></i> Mon volume horaire
        </a>
        <a href="{{ route('espace.complementaires') }}" class="nav-link {{ request()->routeIs('espace.complementaires') ? 'active' : '' }}">
            <i class="fa-solid fa-hourglass-end"></i> Mes heures compl.
        </a>
        <a href="{{ route('espace.ressources') }}" class="nav-link {{ request()->routeIs('espace.ressources') ? 'active' : '' }}">
            <i class="fa-solid fa-book-open"></i> Mes ressources
        </a>
        <a href="{{ route('espace.documents') }}" class="nav-link {{ request()->routeIs('espace.documents') ? 'active' : '' }}">
