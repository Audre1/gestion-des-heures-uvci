            ...
            <div class="card stat-card h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="stat-label">Activités en attente</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-7">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><i class="fa-solid fa-list-check text-uvci-amber me-2"></i>Activités en attente de
                        validation</span>
                        ...
                        <tbody>
                            @forelse ($activitesEnAttente as $a)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $a['type'] == 'Création' ? 'bg-success' : 'bg-warning text-dark' }}">
                                            {{ ucfirst($a['type']) }}
                                        </span>
                                    </td>
        ...
        <div class="col-lg-5">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('affectations.index') }}" class="small text-uvci-purple fw-semibold">Tout
                        voir</a>
                </div>
                <div class="table-responsive">
                    <table class="table align-middle mb-0">
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        <a href="{{ route('enseignants.index') }}" class="btn btn-uvci-outline"
                            style="background:#e6f7ee;border-color:#00a54e;color:#008a41;">
                            <i class="fa-solid fa-chalkboard-user me-1"></i> Gérer les enseignants
                        </a>
                        <a href="{{ route('affectations.index') }}" class="btn btn-uvci-outline"
                            style="background:#f7e9f6;border-color:#91268f;color:#741d72;">
                            <i class="fa-solid fa-link me-1"></i> Gérer les affectations
                        </a>
                        <a href="{{ route('cours.index') }}" class="btn btn-uvci-outline"
                            style="background:#dbeafe;border-color:#2563eb;color:#1d4ed8;">
                            <i class="fa-solid fa-book me-1"></i> Gérer les cours
                        </a>
                        <a href="{{ route('activites.index') }}" class="btn btn-uvci-outline"
                            style="background:#fef3c7;border-color:#d97706;color:#92400e;">
                            <i class="fa-solid fa-list-check me-1"></i> Valider des activités
                        </a>
                        <a href="{{ route('volumes.index') }}" class="btn btn-uvci-outline"
                            style="background:#cffafe;border-color:#0891b2;color:#155e75;">
