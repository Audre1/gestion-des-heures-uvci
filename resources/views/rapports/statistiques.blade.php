<x-app-page title="Statistiques pédagogiques" section="Rapports & Statistiques" icon="fa-solid fa-chart-column"
    subtitle="Répartition des activités par type, niveau et département.">

    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('rapports.statistiques.generate') }}" method="POST">
                        @csrf
