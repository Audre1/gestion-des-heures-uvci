<x-app-page title="État des heures complémentaires" section="Rapports & Statistiques" icon="fa-solid fa-clock"
    subtitle="Liste des heures effectuées au-delà du service statutaire.">

    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('rapports.heures-complementaires.generate') }}" method="POST">
                        @csrf
