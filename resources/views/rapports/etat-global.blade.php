<x-app-page title="État global des heures" section="Rapports & Statistiques" icon="fa-solid fa-list-ol"
    subtitle="Récapitulatif de tous les volumes horaires de l'université.">

    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('rapports.etat-global.generate') }}" method="POST">
                        @csrf
