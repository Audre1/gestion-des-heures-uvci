<x-app-page title="État de paiement collectif" section="Rapports & Statistiques" icon="fa-solid fa-file-invoice-dollar"
    subtitle="Synthèse des rémunérations dues par période.">

    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('rapports.paiement-collectif.generate') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="periode" class="form-control" placeholder="Ex: Janvier 2026, Février 2026">
                        </div>
