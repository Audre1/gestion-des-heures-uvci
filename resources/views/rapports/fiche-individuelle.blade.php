<x-app-page title="Fiche individuelle enseignant" section="Rapports & Statistiques" icon="fa-solid fa-id-card"
    subtitle="Génération de la fiche individuelle d'un enseignant.">

    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('rapports.fiche-individuelle.generate') }}" method="POST">
                        @csrf
