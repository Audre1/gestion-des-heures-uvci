...
<span class="badge badge-soft-purple">
    Enseignant
                    ...
                    <hr>
                    <div class="d-flex justify-content-between py-1"><span class="text-muted">Matricule</span>  <span class="fw-semibold">{{ $enseignant->matricule }}</span> </div>
                    <div class="d-flex justify-content-between py-1"><span class="text-muted">Département</span> <span class="fw-semibold"> {{ $enseignant->departement->nom ?? 'Non défini' }}</span> </div>
                    <div class="d-flex justify-content-between py-1"><span class="text-muted">Grade</span> <span class="fw-semibold">
    {{ $enseignant->grade->libelle ?? 'Non défini' }}
</span> </div>
                    <div class="d-flex justify-content-between py-1"><span class="text-muted">Statut</span> <span class="badge badge-soft-green">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form action="{{ route('profil.index') }}" method="GET"><div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Nom</label><input class="form-control" value="{{ $enseignant->nom }}"></div>
                        <div class="col-md-6"><label class="form-label">Prénom</label><input class="form-control" value="{{ $enseignant->prenom }}"></div>
                        <div class="col-md-6"><label class="form-label">Email</label><input type="email" class="form-control" value="{{ $enseignant->email }}"></div>
                        <div class="col-md-6"><label class="form-label">Téléphone</label><input class="form-control" value="{{ $enseignant->telephone }}"></div>
