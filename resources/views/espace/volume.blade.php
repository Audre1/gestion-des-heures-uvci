<x-app-page title="Mon volume horaire" section="Espace Enseignant" icon="fa-solid fa-stopwatch"
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3"><div class="card stat-card"><div class="card-body d-flex align-items-center gap-3">
            ...
            <div> <div class="stat-value">{{ $serviceStatutaire }} h</div>  <div class="stat-label">Service statutaire</div></div>

        </div></div></div>
        <div class="col-md-3"><div class="card stat-card"><div class="card-body d-flex align-items-center gap-3">
            <div class="stat-icon amber"><i class="fa-solid fa-clock"></i></div>

            <div> <div class="stat-value">{{ $heuresComplementaires }} h</div>  <div class="stat-label">Heures complémentaires</div></div>
        </div></div></div>
        <div class="col-md-3"><div class="card stat-card"><div class="card-body d-flex align-items-center gap-3">
            <div class="stat-icon purple"><i class="fa-solid fa-list-check"></i></div>

            <div> <div class="stat-value">{{ $nombreActivites }}</div> <div class="stat-label">Activités validées</div></div>
    ...
    <div class="row g-3">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @php $months = $evolutionMensuelle; @endphp

                    <div class="d-flex align-items-end justify-content-around gap-3" style="height:210px">
                        @foreach($months as $m => $h)
                            <div class="text-center flex-fill">
                                <div class="mx-auto rounded-top" style="width:55%;height:{{ $h*3 }}px;background:{{ $loop->index % 2 ? 'var(--uvci-purple)' : 'var(--uvci-green)' }}"></div>
        ...
        <div class="col-lg-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between py-2 border-bottom"><span class="text-muted">Grade</span> <span class="fw-semibold">
    {{ $enseignant->grade->libelle ?? 'Non défini' }}
</span> </div>
                    <div class="d-flex justify-content-between py-2 border-bottom"><span class="text-muted">Statut</span> <span class="badge badge-soft-green">
    {{ $enseignant->statut ?? 'Non défini' }}
</span> </div>
                    <div class="d-flex justify-content-between py-2 border-bottom"><span class="text-muted">Taux horaire</span> <span class="fw-semibold">
    {{ number_format($tauxHoraire->montant ?? 0, 0, ',', ' ') }} FCFA
</span> </div>
                    <div class="d-flex justify-content-between py-2"><span class="text-muted">Charge globale</span> <span class="fw-semibold text-uvci-purple">
    {{ $chargeGlobale }} %
</span> </div>
