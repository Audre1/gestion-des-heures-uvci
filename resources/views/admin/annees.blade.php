                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="libelle" class="form-control"
                                        value="{{ old('libelle', $annee->libelle) }}" placeholder="Ex : 2026-2027" required>
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label fw-semibold">Date de début <span class="text-danger">*</span></label>
                                    <input type="date" name="date_debut" class="form-control"
                                        value="{{ old('date_debut', $annee->date_debut ? $annee->date_debut->format('Y-m-d') : '') }}" required>
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label fw-semibold">Date de fin <span class="text-danger">*</span></label>
                                    <input type="date" name="date_fin" class="form-control"
                                        value="{{ old('date_fin', $annee->date_fin ? $annee->date_fin->format('Y-m-d') : '') }}" required>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex gap-4">
                                        <div class="form-check">
                                            <input type="radio" name="statut" id="statutAvenir{{ $annee->id }}"
                                                value="a_venir" class="form-check-input"
                                        ...
                                        <div class="form-check">
                                            <input type="radio" name="statut" id="statutEnCours{{ $annee->id }}"
                                                value="en_cours" class="form-check-input"
                                        ...
                                        <div class="form-check">
                                            <input type="radio" name="statut" id="statutCloturee{{ $annee->id }}"
                                                value="cloturee" class="form-check-input"
                                                {{ old('statut', $annee->statut) === 'cloturee' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="statutCloturee{{ $annee->id }}">
                                                Clôturée
                                            </label>
                                        </div>
                                    </div>
            ...
            <div class="modal fade" id="activateAnneeModal{{ $annee->id }}" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow">
                        ...
                        <div class="modal-body p-4">
                            <p class="mb-3">
                                Voulez-vous définir l'année <strong>{{ $annee->libelle }}</strong> comme année académique active ?
                            </p>
                ...
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="alert alert-warning mb-0">
                            ...
                            <span class="small">Du {{ $annee->date_debut ? $annee->date_debut->format('d/m/Y') : 'N/A' }} au {{ $annee->date_fin ? $annee->date_fin->format('d/m/Y') : 'N/A' }}</span>
                        </div>
